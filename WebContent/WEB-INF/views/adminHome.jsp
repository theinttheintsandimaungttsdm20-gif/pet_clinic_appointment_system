...
<%@ include file="/resources/admin/header/HeaderAndMainSlider.jsp" %>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<c:url value="resources/admin/plugins/barChart/cssgraph_bar.css"/>">
    <link rel="stylesheet" href="<c:url value="resources/admin/plugins/barChart/cssgraph_plot.css"/>">
