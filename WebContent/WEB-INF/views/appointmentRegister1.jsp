  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Appoiment Register>>Step(1)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
        ...
        <div class="card-header">
              <h3 class="card-title">Appoiment Register</h3>
              </div>
        <div class="card-body">
          <form:form action="appointmentRegisterPath2" modelAttribute="appointmentRegisterForm.appointmentForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
				...
				Appointment Date :
                 ...
                 <form:input type="text" id="appointmentDate" path="appointmentDate" name="appointmentDate"  class="form-control"  data-mask="data-mask" placeholder="dd/MM/yyyy" />
                  </div>
         		 </div>
                ...
                <div class="col-sm-6">
                      ...
                      <div class="form-group">
                       ...
                       <form:options items="${appointmentRegisterForm.mapServicTypes}"/>
                       </form:select>
                      </div>
                    </div> 
                <div class="form-group">
