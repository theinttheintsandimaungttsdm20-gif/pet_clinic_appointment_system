          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="#">
              ...
              <li class="breadcrumb-item active">Appoiment Register>>Step(3)</li>
                ...
                <h3 class="card-title">Appointment Register</h3>
              </div>
        <div class="card-body">
          <form:form action="appointmentRegisterSubmitPath" modelAttribute="appointmentRegisterForm.appointmentForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                <div class="row">
                 <div class="col-md-6">
                 ...
                 ${ownerId}
                      ...
                      <div class="form-group">
                       ...
                       <form:checkboxes  items="${appointmentRegisterForm.mapServices}" path="selectedServices" /><br>
                       </div>
                      </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Appointment Info</label> 
                         <form:textarea  class="form-control" rows="3" id="appointmentInfo" path="appointmentInfo" name="appointmentInfo"  placeholder="Enter Appointment Info....."/>
                      </div>
                    </div>
                     <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                       ...
                       <form:select path="petId" name="petId" id="petId" class="form-control" > 
                       <form:options items="${appointmentRegisterForm.mapPets}"/>
                       </form:select>
                      </div>
                </div> 
                 <div class="form-group">
             ...
             class="btn btn-block bg-gradient-primary btn-m" value="Confirm"/>
             </div>
            </div>
              <div class="form-group">
	             <div class="input-group">
