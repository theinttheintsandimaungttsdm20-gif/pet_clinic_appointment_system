...
<%@ include file="/resources/admin/header/HeaderAndMainSlider.jsp" %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rank Update</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <div class="card card-success">
        ...
        <div class="card-body">
          <form:form action="rankUpdateSubmitPath" modelAttribute="rankRegisterForm.rankForm" method="POST" enctype="multipart/form-data" >
        	...
        	<div class="col-md-6">
				...
				Rank Id :
                 ...
                 <form:input type="text" id="rankId" path="rankId" name="rankId"  class="form-control"  data-mask="data-mask" readonly="true"/>
                  </div>
         		 </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <td>${s.index+1}</td>
				...
				<td>${at.rankName}</td>
				<td>${at.shortTerm}</td>
				<td><a href="rankDeletePath?frmRankId=${at.rankId}">Delete</a></td>
				<td><a href="rankUpdatePath?frmRankId=${at.rankId}">Update</a></td>
                </tr>
