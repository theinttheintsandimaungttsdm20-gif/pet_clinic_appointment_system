...
<%@ include file="/resources/admin/header/HeaderAndMainSlider.jsp" %>
  ...
  <div class="card card-success">
        ...
        <div class="card-body">
          <form:form action="servicRegisterSubmitPath" modelAttribute="servicRegisterForm.servicForm" method="POST" enctype="multipart/form-data" >
        ...
        <div class="col-12">
          <div class="card">
			...
			<tr>
				...
				<td><a href="servicDeletePath?frmServicId=${at.servicId}" class="btn btn-block btn-outline-primary btn-sm">Delete</a></td>
				<td><a href="servicUpdatePath?frmServicId=${at.servicId}" class="btn btn-block btn-outline-primary btn-sm">Update</a></td>
			</tr>		
		</c:forEach>
                </tbody>
                <tfoot>
