...
<%@ include file="/resources/admin/header/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
    ...
    <!-- Main content -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<td><a href="showAppoinmentByServicTypeSubmitPath?frmServicTypeId=${at.servicTypeId}" class="btn btn-block btn-outline-primary btn-sm">Next</a></td>
		        </tr>
                </c:forEach>
                </tbody>
                <tfoot>
      ...
      <p class="mb-0">
        <a href="exalByDoctorSchedule" class="text-center">Export Exal By Schedules</a>
      </p>
      <p class="mb-0">
        <a href="exalByServicType" class="text-center">Export Exal By ServicTypes</a>
      </p>
    <!-- /.content -->
    </section>
  </div>
