  ...
  <section class="content">
    ...
    <!-- Main content -->
       <div class="card card-success">
                ...
                <h3 class="card-title">Show Pet Owner Information</h3>
              </div>
        <div class="card-body">
        <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
        	 ...
        	 <form:form action="speciesRegisterSubmitPath" modelAttribute="speciesRegisterForm.speciesForm" method="POST" enctype="multipart/form-data" >
                 ...
                 <form:input type="text" id="SpeciesName" path="SpeciesName" name="SpeciesName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
                 <div class="form-group">
	             <div class="input-group">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
             <c:forEach var="at" items="${speciesRegisterForm.species}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.speciesId}</td>
				<td>${at.speciesName}</td>
				<td><a href="speciesDeletePath?frmSpeciesId=${at.speciesId}" class="btn btn-block btn-outline-primary btn-sm">Delete</a></td>
				<td><a href="speciesUpdatePath?frmSpeciesId=${at.speciesId}" class="btn btn-block btn-outline-primary btn-sm">Update</a></td>
			</tr>		
		    </c:forEach>
                </tbody>
                <tfoot>
